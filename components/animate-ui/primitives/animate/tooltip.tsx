...
function TooltipOverlay() {
  ...
  const Component = (rendered.data?.contentAsChild ? Slot : motion.div) as React.ComponentType<AnyProps>;
...
function TooltipTrigger({
  ...
  const Component = (asChild ? Slot : motion.div) as React.ComponentType<any>;
